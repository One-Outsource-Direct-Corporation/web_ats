...
const softSkillsData = [
  {
    ...
    rating: 25,
    remarks:
      "Demonstrates excellent verbal and written communication skills with clear articulation of ideas.",
  },
  {
    skill: "Teamwork",
    rating: 20,
    remarks:
      "Shows good collaboration abilities but could improve in leading team discussions.",
  },
  {
    skill: "Problem Solving",
    rating: 18,
    remarks:
      "Adequate problem-solving approach with room for more creative solutions.",
  },
  {
    skill: "Adaptability",
    rating: 10,
    remarks:
      "Shows basic adaptability but may struggle with rapid changes in work environment.",
  },
];
...
const technicalSkillsData = [
  {
    ...
    rating: 35,
    remarks:
      "Strong proficiency in multiple programming languages with excellent coding practices.",
  },
  {
    skill: "System Design",
    rating: 25,
    remarks:
      "Good understanding of system architecture with solid design principles.",
  },
  {
    skill: "Database Management",
    rating: 8,
    remarks:
      "Basic database knowledge with limited experience in complex queries.",
  },
  {
    skill: "Testing & Debugging",
    rating: 7,
    remarks:
      "Fundamental testing skills but needs improvement in comprehensive test coverage.",
  },
];
...
const coreValuesData = [
  {
    ...
    rating: 35,
    remarks:
      "Demonstrates strong ethical standards and honest communication in all interactions.",
  },
  {
    skill: "Innovation",
    rating: 28,
    remarks:
      "Shows creative thinking and willingness to explore new approaches to challenges.",
  },
  {
    skill: "Customer Focus",
    rating: 17,
    remarks:
      "Good understanding of customer needs with adequate service orientation.",
  },
  {
    skill: "Continuous Learning",
    rating: 10,
    remarks:
      "Shows interest in learning but needs more proactive approach to skill development.",
  },
];
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="interviewer"
                    value="Sarah Johnson - Senior HR Manager"
                    readOnly
                    className="bg-gray-50"
                  />
                </div>
