        ...
        <div className="bg-white rounded-lg shadow-xl p-6 max-h-[90vh] overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Plan, organize, and reschedule interview
            </p>
            ...
            <CardContent className="p-4 space-y-4">
              ...
              {(interviewType === "offsite" || interviewType === "phone") && (
                <div>
                  ...
                  <Input
                    id="meeting-title"
                    placeholder="Interview with [Candidate Name]"
                  />
                </div>
              )}
...
export default function JobManagement() {
  ...
  const [selectedApplicantForReschedule, setSelectedApplicantForReschedule] =
    useState("");
                        ...
                        >
                          ...
                          <TableCell className="border border-gray-200 py-3 px-3 lg:py-4 lg:px-4 text-center w-20 align-middle">
                            <Button
                              ...
                              onClick={() =>
                                handleRescheduleInterview(applicant.name)
                              }
                            >
                              Reschedule
                            </Button>
                          ...
                          <TableCell className="border border-gray-200 py-3 px-3 lg:py-4 lg:px-4 text-center w-24 align-middle">
                            <Button
                              ...
                              onClick={() =>
                                navigate(
                                  `/job/list/applicants/${applicant.id}/IEForm`
                                )
                              }
                            >
                              View
