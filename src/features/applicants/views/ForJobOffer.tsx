          ...
          <div className="p-8 space-y-6">
            ...
            <div className="mt-8 space-y-4 ml-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-gray-600 mt-1 ml-48">
                  **The company reserves the right to change your schedule as it
                  deems necessary.
                </p>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-gray-600 mt-1 ml-48">
                  **The company reserves the right to change your work
                  assignment and duties as it deems necessary.
                </p>
              </div>
              ...
              <div className="flex">
                ...
                <span className="text-sm text-gray-600 ml-2">
                  **or another mutually agreed upon date
                </span>
              </div>
            </div>

            {/* Compensation & Benefits Separator */}
            <div className="bg-blue-600 text-white text-center py-2 font-bold mt-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed border-collapse border border-gray-300">
                <thead>
                  <tr>
                    <th className="w-1/4 border border-gray-300 p-2 text-left font-bold">
                      Cash
                    </th>
                    <th className="w-1/4 border border-gray-300 p-2 text-left font-bold">
                      Monthly
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">
                      1/12 of the annual basic salary/Prorated monthly
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-2 pl-4">
              ...
              <table className="w-full border-collapse border border-gray-300 min-w-[800px]">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">₱3,448.28</td>
                    <td className="border border-gray-300 p-2 whitespace-normal break-words">
                      5 days annually/subject to company sick leave policy
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <table className="w-full border-collapse border border-gray-300">
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">
                      Subject to the company's affordability
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">Yes</td>
                    <td className="border border-gray-300 p-2">
                      Available after 8 months of employment, subject to the
                      medical coverage policy and company affordability
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-2">
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">Yes</td>
                    <td className="border border-gray-300 p-2">
                      Discounts on One Tech Smart Solutions
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-2">
                    ...
                    <td className="border border-gray-300 p-2">Yes</td>
                    <td className="border border-gray-300 p-2">
                      Contingent upon the company's financial performance and
                      profitability, as well as individual performance
                      throughout the year
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">
                      Applicable to employees in the Sales Department, based on
                      the company's sales incentives or commission structure
                      program
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">Yes</td>
                    <td className="border border-gray-300 p-2">
                      Subject to company referral policy
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-2">
                      Employee Salary Loan Assistance
                    </td>
                    <td className="border border-gray-300 p-2">Yes</td>
                    <td className="border border-gray-300 p-2">
                      Available after 6 months of employment, in accordance with
                      the company's employee salary loan assistance policy
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="mt-8 text-sm leading-relaxed">
              <p className="mb-4">
                This offer, along with your employment with the company, is
                contingent upon your successful completion of the medical
                examination, employment background verification, and all
                pre-employment requirements. If you accept our offer, please
                indicate your agreement by signing in the space provided below.
              </p>
              <p className="mb-6">
                Thank you, and we look forward to welcoming you to One
                Outsource.
              </p>
            </div>
    ...
    <div className="w-full xl:w-[320px] bg-white xl:border-l border-gray-200 p-4 pt-4 space-y-4 xl:sticky xl:top-0 xl:h-screen xl:overflow-y-auto">
      ...
      <div className="space-y-2">
        {candidates.map((candidate) => (
          <div
            key={candidate.id}
            className="flex items-start gap-2 p-2 rounded-lg border hover:bg-gray-50"
          >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label
                    htmlFor="salary-load-assistance"
                    className="text-sm font-medium text-gray-700 mb-1 block"
                  >
        ...
        <div className="bg-white rounded-lg shadow-xl p-6 max-h-[90vh] overflow-y-auto">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-700 mb-4">
              This applicant has been marked as rejected.
            </p>
          </div>
                ...
                <div>
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="better-candidate">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-4">
        <div className="bg-white rounded-lg shadow-xl p-6">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-700 mb-4">
              Are you sure you want to rescind the offer made to this applicant?
            </p>
          </div>
              ...
              <div>
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="position-eliminated">
                      Position eliminated
                    </SelectItem>
                    ...
                    <SelectItem value="candidate-issues">
                      Issues with candidate background
                    </SelectItem>
                    <SelectItem value="business-changes">
...
export default function JobOfferManagement() {
  ...
  const [selectedApplicantForReject, setSelectedApplicantForReject] =
    useState("");

  const [isRescindOfferOpen, setIsRescindOfferOpen] = useState(false);
  const [selectedApplicantForRescind, setSelectedApplicantForRescind] =
    useState("");
                          ...
                          <TableCell className="border border-gray-200 py-3 px-3 lg:py-4 lg:px-4 align-middle">
                            <div className="flex gap-2 justify-center">
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleRescindOffer(applicant.name)
                                }
