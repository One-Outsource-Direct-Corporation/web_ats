        ...
        <div className="bg-white rounded-lg shadow-xl p-6">
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-700 mb-4">
              Are you sure you want to reconsider this applicant?
            </p>
            <hr className="border-blue-600 border-t-2" />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                <Label
                  htmlFor="reconsider-position"
                  className="text-sm font-medium text-gray-700 mb-1 block"
                >
                  Reconsider to Position
                </Label>
                <Select
                  value={reconsiderPosition}
                  onValueChange={setReconsiderPosition}
                >
                  <SelectTrigger>
              ...
              <div className="flex items-end">
                <Button
                  onClick={() => {
                    console.log(
                      `Reconsidering ${applicant?.name} for the same position`
                    );
                    onClose();
                  }}
                  className="bg-blue-600 text-white hover:bg-blue-700"
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <Button
              onClick={() => {
                console.log(
                  `Reconsidering ${applicant?.name} for ${
                    reconsiderPosition || applicant?.position
                  }`
                );
                onClose();
              }}
...
export default function OfferAndFinalization() {
  ...
  const filteredRescinded = useMemo(
    ...
    [
      searchTerms.rescinded,
      positionFilters.rescinded,
      departmentFilters.rescinded,
    ]
  );
    ...
    <div className="flex flex-col gap-4 mb-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
        <Select
          ...
          onValueChange={(value) =>
            setPositionFilters((prev) => ({ ...prev, [tab]: value }))
          }
        >
        ...
        <Select
          ...
          onValueChange={(value) =>
            setDepartmentFilters((prev) => ({ ...prev, [tab]: value }))
          }
        >
          <SelectTrigger className="w-64 sm:w-48">
      ...
      <div className="min-h-screen bg-gray-50 p-4 mt-20">
        <div className="mx-auto max-w-7xl space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Select
              defaultValue="OfferAndFinalization"
                  ...
                  <TableBody>
                    {filteredRejected.map((applicant) => (
                      <TableRow key={applicant.id}>
                        ...
                        <TableCell className="border border-gray-200 py-3 px-2 text-xs break-words min-h-[80px] align-middle text-center">
                          <a
                            href={`/job-offers/Job_Offer_${applicant.name
                              .split(" ")
                              .pop()}.pdf`}
