  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="space-y-6">
        {/* How Did You Learn */}
        {applicationForm?.how_did_you_hear_about_us !== "disabled" && (
          <div className="space-y-2">
            ...
            <Select
              ...
              required={
                applicationForm.how_did_you_hear_about_us === "required"
              }
            >
              <SelectTrigger>
            ...
            {errors.howDidYouLearn && (
              <p className="text-sm text-red-600">{errors.howDidYouLearn}</p>
            )}
          </div>
        )}

        {/* Certification */}
        {applicationForm?.agreement !== "disabled" && (
          <div className="flex items-start space-x-2 space-y-2">
            ...
            >
              ...
              understand that any false information or omission may disqualify
              me from employment consideration or result in dismissal if
        ...
        {applicationForm?.signature !== "disabled" && (
          <div className="space-y-2">
