...
const QUESTIONNAIRE_DRAFT_STORAGE_KEY = "external-posting:questionnaire-draft:v1";
...
export const questionnaireLocalStore: QuestionnaireLocalStore = {
  saveDraft(data) {
    ...
    localStorage.setItem(QUESTIONNAIRE_DRAFT_STORAGE_KEY, JSON.stringify(record));
  },
