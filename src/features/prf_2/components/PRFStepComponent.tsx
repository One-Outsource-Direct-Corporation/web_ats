...
export default function PRFStepComponent({
  ...
  switch (step) {
    case 1:
      return <PRFStep01 formData={formData} updateFormData={updateFormData} />;
    case 2:
      return <PRFStep02 formData={formData} updateFormData={updateFormData} />;
    case 3:
      return <PRFStep03 formData={formData} updateFormData={updateFormData} />;
    case 4:
      return <PRFStep04 formData={formData} updateFormData={updateFormData} />;
    case 5:
      return <PRFStep05 formData={formData} updateFormData={updateFormData} />;
    case 6:
