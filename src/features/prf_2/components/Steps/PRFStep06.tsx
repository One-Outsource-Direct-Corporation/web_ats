...
import {Building2, Clock, Code, DollarSign, FileText, MapPin, Monitor, Target, Users} from "lucide-react";
import DOMPurify from "dompurify";

interface PRFStep06Props {
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-gray-900">{formData.job_posting.department_display || "Not Specified"}</span>
              </div>
              <div className="flex justify-between items-center py-2">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="text-gray-900">
                {formatName(formData.prf_input.category ?? "")}
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-600 font-medium mb-1">
            ...
            <div className="rounded-lg p-6 flex items-center justify-center">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-700">
                  {formatMoney(Number(formData.job_posting.min_salary || 0))} -{" "}
                  {formatMoney(Number(formData.job_posting.max_salary || 0))}
                </div>
              </div>
            </div>
          </div>
