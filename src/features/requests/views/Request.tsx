...
export default function Request() {
  ...
  return (
    <main className="flex flex-col min-h-screen pt-[100px] bg-gray-50">
      ...
      <div className="flex-grow px-6 pt-[150px] pb-[80px] max-w-7xl mx-auto w-full">
        <table className="min-w-full bg-white text-sm">
          ...
          <tbody>
            ...
            {!loading && !error && positions.length > 0 && (
              <>
                {positions.map((item) => (
                  <tr key={item.unique_id} className="border-t">
                    ...
                    <td className="px-4 py-3 font-medium">{item.job_title}</td>
                    <td className="px-4 py-3">
                      <span
