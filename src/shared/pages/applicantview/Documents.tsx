...
export default function DocumentsPage() {
  ...
  const [showReturnToTrackerModal, setShowReturnToTrackerModal] =
    useState(false);
  ...
  const [documents, setDocuments] = useState<DocumentData[]>([
    {
      id: 1,
      name: "Valid NBI Clearance or Police Clearance",
      status: "Pending",
    },
    ...
    {
      id: 6,
      name: "Photocopy of Dependents Birth Certificate (if applicable)",
      status: "Pending",
    },
    {
      id: 7,
      name: "Photocopy of Marriage Contract (if applicable)",
      status: "Pending",
    },
      ...
      setDocuments((prev) =>
        prev.map((doc) =>
          doc.id === selectedDocument.id
            ? { ...doc, file, status: "Submitted" as const }
            : doc
        )
      );
              ...
              <div className="flex-1 space-y-3">
                {documents.map((document) => {
                  ...
                  if (document.status === "Submitted")
                    ...
                    nameColorClass = "text-yellow-600";
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <span className={`${nameColorClass} font-medium`}>
                          {document.name}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="mb-4">
                      {selectedDocument.file.type.startsWith("image/") ? (
                        <img
                          src={
                            URL.createObjectURL(selectedDocument.file) ||
                            "/placeholder.svg"
                          }
                        ...
                        <p className="text-sm text-gray-600">
                          File uploaded:{" "}
                          <strong>{selectedDocument.file.name}</strong>
                        </p>
                      )}
                    </div>
